...
export async function GET(request, context) {
  try {
    ...
    if (isValidUuid(eventId)) {
      ...
      // Demo starter RSVPs for showcase events
      rsvps = [
        {
          id: "rsvp-demo-1",
          event_id: eventId,
          full_name: "Dr. Amine Zerrouki",
          email: "amine.zerrouki@sonatrach.dz",
          company: "Sonatrach Energy",
          job_title: "Head of Infrastructure",
          status: "attending",
          plus_ones: 1,
          plus_ones_names: ["Leila Zerrouki"],
          dietary_preference: "Halal",
          dietary_notes: "",
          notes: "Need VIP parking badge",
          checked_in: false,
        ...
        },
        {
          ...
          email: "sarah.chen@globalai.com",
          company: "Global AI Labs",
          job_title: "Lead ML Scientist",
          status: "attending",
          plus_ones: 0,
          plus_ones_names: [],
        ...
        },
        {
          ...
          email: "m.vance@venturecap.co",
          company: "Vance Partners VC",
          job_title: "Managing Partner",
          status: "attending",
          plus_ones: 2,
          plus_ones_names: ["Elena Rostova", "David Vance"],
          dietary_preference: "Gluten-Free",
          dietary_notes: "Celiac",
          notes: "Arriving by 10 AM",
          checked_in: false,
        ...
        },
        {
          id: "rsvp-demo-4",
          event_id: eventId,
          full_name: "Yassine Bouzid",
          email: "yassine.bouzid@algeriatelecom.dz",
          company: "Algerie Telecom",
          job_title: "Senior Telecom Engineer",
          status: "waitlisted",
          plus_ones: 0,
          plus_ones_names: [],
          dietary_preference: "Halal",
          dietary_notes: "",
          notes: "Ready to attend if slot opens",
          checked_in: false,
        ...
        },
        {
          ...
          email: "f.khelifi@biotech-algeria.org",
          company: "BioTech North Africa",
          ...
          dietary_notes: "",
          notes: "Conflict with university exam period",
          checked_in: false,
