...
export default function VisitorPortal({ 
      ...
      for (const reg of registrations) {
        try {
          const qrData = JSON.stringify({
            ...
            attendeeName: user?.fullName || "Sarah Visitor",
  ...
  const handleRsvpSubmit = async (e) => {
    ...
    try {
      ...
      if (newPass) {
        ...
        setQrCodeUrls(prev => ({ ...prev, [newPass.id]: qrUrl }));
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
      {/* Top SaaS Header */}
      <header className="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-50 flex items-center justify-between shadow-xs">
        ...
        <div className="hidden md:flex items-center bg-slate-100 p-1 rounded-2xl border border-slate-200">
          ...
          >
            <Compass size={14} className={activeTab === "explore" ? "text-emerald-600" : ""} />
          ...
          >
            <Ticket size={14} className={activeTab === "my-passes" ? "text-emerald-600" : ""} />
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            title="Switch to Event Organizer Mode"
          >
          ...
          <div 
            ...
            className="flex items-center gap-2.5 pl-1 p-1 rounded-xl hover:bg-slate-100 cursor-pointer transition-colors"
            title="Open My Networking Profile"
          >
            <img 
            ...
            <div className="hidden sm:flex flex-col text-left">
              <span className="text-xs font-bold text-slate-800 leading-tight">{user?.fullName || "Visitor"}</span>
              <span className="text-[10px] text-blue-600 font-medium">My Profile</span>
            </div>
          </div>
                    ...
                    <div className="p-6 pt-0 border-t border-slate-100 mt-2 space-y-2">
                      <div className="grid grid-cols-2 gap-2 pt-3">
                        <button
                          ...
                          className="py-2.5 px-3 bg-slate-50 hover:bg-slate-100 text-slate-700 rounded-xl text-[11px] font-bold border border-slate-200 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                        >
                      ...
                      {isRegistered ? (
                        <button
                          onClick={() => setActiveTab("my-passes")}
                          className="w-full py-3 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 hover:bg-emerald-100 transition-colors cursor-pointer"
                        >
                          <QrCode size={14} />
                        ...
                        <button
                          ...
                          className="w-full py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-md shadow-emerald-600/20 transition-all cursor-pointer"
                        >
                          <Ticket size={14} />
                          <span>Claim Free Pass / RSVP</span>
                        </button>
                      )}
                    </div>
                  </div>
        ...
        {activeTab === "my-passes" && (
          <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <button
                onClick={() => setActiveTab("explore")}
                className="self-start sm:self-auto px-4 py-2.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer"
              >
                <Compass size={14} />
                <span>+ Browse More Summits</span>
              </button>
            </div>
                      ...
                      <div className="pt-4 border-t border-slate-100 flex flex-col gap-3">
                        <div className="flex items-center justify-between text-xs">
                          <div>
                            ...
                            <span className="font-bold text-slate-800">{user?.fullName || "Sarah Visitor"}</span>
                          </div>
                          <div>
                        ...
                        <div className="flex items-center gap-2 pt-1">
                          <button
                            ...
                            className="flex-1 py-2 px-3 bg-slate-50 hover:bg-slate-100 text-slate-700 rounded-xl text-[10px] font-bold border border-slate-200 flex items-center justify-center gap-1 transition-colors cursor-pointer"
                          >
              ...
              <div>
                ...
                <form onSubmit={handleRsvpSubmit} className="space-y-4 text-left">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold shadow-md shadow-emerald-600/20 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-2"
                  >
                    {rsvpSubmitting ? (
